...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  let indicador= arreglo[0]
  let verdad  
  for(let i=0 ; i<arreglo.length; i++){
    if (indicador!==arreglo[i]){
      verdad=false
      break
    } else{
      verdad=true
...
function breakStatement(numero) {
  ...
  do {
    seguir= seguir+2
    arreglado.push(seguir)
    ++i
    if(i==seguir){
      arreglado= "Se interrumpió la ejecución"
      break
    }
  } while (i<10);
  return arreglado
